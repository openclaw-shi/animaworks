...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "handler.bg_not_enabled": {"ja": "Error: バックグラウンドタスク機能が無効です", "en": "Error: Background task feature is not enabled"},
    "handler.bg_task_not_found": {"ja": "Error: タスク {task_id} が見つかりません", "en": "Error: Task {task_id} not found"},
    "handler.bg_invalid_status": {"ja": "Error: 無効なステータス: {status}。有効値: running, completed, failed, pending", "en": "Error: Invalid status: {status}. Valid values: running, completed, failed, pending"},
