...
class TestBaseToolCount:
    ...
    def test_base_tool_count(self, executor):
        """Base tools should be 24 (4 memory + 1 archive + 4 messaging + 1 procedure + 1 knowledge + 1 check_permissions + 4 file + 2 search + 1 discovery + 1 tool_management + 3 task + 1 skill)."""
